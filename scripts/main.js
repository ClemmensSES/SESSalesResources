...
const DEFAULT_WIDGETS = [
    ...
    { id: 'lmp-analytics', name: 'LMP Analytics V2', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3v18h18"/><path d="M18 17V9"/><path d="M13 17V5"/><path d="M8 17v-3"/></svg>', src: 'widgets/lmp-analytics-v2.html', fullWidth: true, defaultHeight: 800, minHeight: 400, maxHeight: 1200 },
