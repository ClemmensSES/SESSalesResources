/**
 * Secure Energy Analytics Portal - Main Controller v2.9
 * 
 * v2.9 Updates:
...
window.editUser = function(userId) {
    ...
    content.innerHTML = '<div class="edit-user-form">' +
        ...
        '<div class="widget-permission-item"><span>Feedback & Support</span><label class="toggle-switch"><input type="checkbox" id="edit-perm-feedback" ' + getChecked('feedback') + '><span class="toggle-slider"></span></label></div>' +
        '</div>' +
